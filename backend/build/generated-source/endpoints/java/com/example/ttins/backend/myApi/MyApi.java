 ...
 * on 2015-12-30 at 09:22:19 UTC 
 * Modify at your own risk.
 */

package com.example.ttins.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getJokeFromServer".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link GetJokeFromServer#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public GetJokeFromServer getJokeFromServer() throws java.io.IOException {
    GetJokeFromServer result = new GetJokeFromServer();
    initialize(result);
    return result;
  }

  public class GetJokeFromServer extends MyApiRequest<com.example.ttins.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link GetJokeFromServer#execute()} method to invoke the remote operation.
     * <p> {@link GetJokeFromServer#initialize(com.google.api.client.googleapis.services.AbstractGoogl
     * eClientRequest)} must be called to initialize this instance immediately after invoking the
     * constructor. </p>
     *
     * @since 1.13
     */
    protected GetJokeFromServer() {
      super(MyApi.this, "GET", REST_PATH, null, com.example.ttins.backend.myApi.model.MyBean.class);
    }
    ...
    @Override
    public GetJokeFromServer setAlt(java.lang.String alt) {
      return (GetJokeFromServer) super.setAlt(alt);
    }

    @Override
    public GetJokeFromServer setFields(java.lang.String fields) {
      return (GetJokeFromServer) super.setFields(fields);
    }

    @Override
    public GetJokeFromServer setKey(java.lang.String key) {
      return (GetJokeFromServer) super.setKey(key);
    }

    @Override
    public GetJokeFromServer setOauthToken(java.lang.String oauthToken) {
      return (GetJokeFromServer) super.setOauthToken(oauthToken);
    }

    @Override
    public GetJokeFromServer setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetJokeFromServer) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetJokeFromServer setQuotaUser(java.lang.String quotaUser) {
      return (GetJokeFromServer) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetJokeFromServer setUserIp(java.lang.String userIp) {
      return (GetJokeFromServer) super.setUserIp(userIp);
    }

    @Override
    public GetJokeFromServer set(String parameterName, Object value) {
      return (GetJokeFromServer) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.ttins.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.example.ttins.backend.myApi.model.MyBean.class);
